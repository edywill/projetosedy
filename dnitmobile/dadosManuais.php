...
<table border="0" cellpadding="2" cellspacing="0" width="80%">
  <tr align="center" valign="top" align="center">
    ...
    <form name='cadmanuais' method="post" action="atdadosmanuais.php">
<table width="100%" cellpadding='0' cellspacing='0' border='1' name='tabelacadastro'>
  <thead>
   <tr bgcolor="#DCDBDB">
     <td colspan="2" align="right"><font size="+3" color="#000066"><strong>DADOS MANUAIS - INFORMAR BR/UF/KM</strong></font></tr>			
			</thead>
			<tbody>
			<tr align="left">
            <th width="20%" height="33" bgcolor="#DCDBDB"><font size="+1" color="#000066">BR:</font></th>
            <td bgcolor="#FFFFFF">
            <input type="text" name="br" size="30" maxlength="3" value='' />
            </td></tr>
            
            <tr align="left">
            <th height="32" bgcolor="#DCDBDB"><font size="+1" color="#000066">UF:</font></th>
            <td bgcolor="#FFFFFF">
             <select name="uf">
            <option value="0">Selecione</option>
            <?php 
			$sqlEstado=odbc_exec($conCab,"SELECT id,sigla FROM estado");
			while($objEstados=odbc_fetch_object($sqlEstado)){
			echo "<option value='".$objEstados->id."'>".$objEstados->sigla."</option>";	
				}
			?>
            </select>
            </td></tr>
            ...
            <tr align="left">
            <th height="32" bgcolor="#DCDBDB"><font size="+1" color="#000066">KM:</font></th>
            <td bgcolor="#FFFFFF">
            <input type="hidden" name="id" size="60" value='<?php echo trim($id); ?>' />
            <input type="text" name="km" size="30" maxlength="5" value='' /></td></tr>
            <tr align="left"><td height="33"><a href="analiseOcorr.php"><input type="button" name="voltar" value='<<Voltar'/></a></td><td align="right"><input class="botao" type="submit" name="atualiza" value='Atualiza'/></td></tr>
		    </tbody>
            </table>
            </form>
            </td></tr></table>
