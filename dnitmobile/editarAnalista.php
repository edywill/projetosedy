...
<table border="0" cellpadding="2" cellspacing="0" width="80%">
  <tr align="center" valign="top" align="center">
    ...
    <form name='atanalista' method="post" action="atanalista.php">
  ...
  <thead>
   <tr bgcolor="#DCDBDB">
     <td colspan="2" align="right"><font size="+3" color="#000066"><strong>CADASTRO DE ANALISTA</strong></font></tr>			
            ...
            <td bgcolor="#FFFFFF"><input type="text" name="nome" size="60" maxlength="32" value='<?php echo utf8_encode($query['nome']); ?>' />
            <input type="hidden" name="id" size="60" maxlength="32" value='<?php echo $query['id_login']; ?>' /></td></tr>
            
            <tr align="left">
            <th height="32" bgcolor="#DCDBDB"><font size="+1" color="#000066">E-mail:</font></th>
            <td bgcolor="#FFFFFF"><input type="text" name="email" size="60" maxlength="32" value='<?php echo $query['email']; ?>' /></td></tr>
            
            <tr align="left">
            <th height="32" bgcolor="#DCDBDB"><font size="+1" color="#000066">Usuário:</font></th>
            <td bgcolor="#FFFFFF"><input type="text" name="usuario" size="60" maxlength="32" value='<?php echo $query['usuario']; ?>' /></td></tr>
            
            <tr align="left">
            <th height="32" bgcolor="#DCDBDB"><font size="+1" color="#000066">Senha:</font></th>
            <td bgcolor="#FFFFFF"><input type="password" name="senha" size="60" maxlength="10" value='' /><br /><font size="-2">*Informar somente caso deseje alterar a senha do usuário.</font></td></tr>
			<tr align="left">
			...
			if($query['perfil']=='adm'){
			?>
            <input type="radio" name="perfil" value="usr" /> - Usuário Comum <br />
            <input type="radio" name="perfil" value="adm" checked="checked"/> - Administrador</td></tr>
            <?php 
			}else{
				?>
