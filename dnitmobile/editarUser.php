...
<table border="0" cellpadding="2" cellspacing="0" width="80%">
  <tr align="center" valign="top" align="center">
    ...
    <form name='atcad' method="post" action="atuser.php">
<table width="100%" cellpadding='0' cellspacing='0' border='1' name='tabelacadastro'>
  <thead>
   <tr bgcolor="#DCDBDB"><td colspan="2" align="right"><font size="+3" color="#000066"><strong>CADASTRO DO USUÁRIO</strong></font></tr>			
			</thead>
            <?php 
			...
			$sql = "SELECT * FROM device WHERE id='".$idUser."'";
   			$query = odbc_fetch_array(odbc_exec($conCab,$sql));
			?>
			<tbody>
			<tr align="left"><th width="20%" height="33" bgcolor="#DCDBDB"><font size="+1" color="#000066">Nome:</font></th><td bgcolor="#FFFFFF"><input type="text" name="nome" size="60" maxlength="32" value='<?php echo utf8_encode($query['name']); ?>' /><input type="hidden" name="id" size="60" maxlength="32" value='<?php echo $query['id']; ?>' /></td></tr>
            <tr align="left"><th height="32" bgcolor="#DCDBDB"><font size="+1" color="#000066">E-mail:</font></th><td bgcolor="#FFFFFF"><input type="text" name="email" size="60" maxlength="32" value='<?php echo $query['email']; ?>' /></td></tr>
            <tr align="left"><th height="33" bgcolor="#DCDBDB"><font size="+1" color="#000066">Dispositivo:</font></th><td bgcolor="#FFFFFF">
            <?php 
			if(!empty($query['iphone'])){
				echo "IPHONE";
				}else{
					echo "ANDROID";
					}
?>
            <br /><font size="-1">*Essa informação só pode ser atualizada no dispositivo do usuário.</font></td></tr>
            <tr align="left"><td height="33"><a href="usuarios.php"><input type="button" name="voltar" value='<<Voltar'/></a></td><td align="right"><input class="botao" type="submit" name="atualiza" value='Atualizar'/></td></tr>
		    </tbody>
            </table>
            </form>
            </td></tr></table>
