...
$execAtualiza=odbc_exec($conCab,"INSERT INTO login (id_login,nome,email,usuario,senha,perfil) VALUES ('".$novoId."','".utf8_decode($nome)."','".utf8_decode($email)."','".utf8_decode($usuario)."','".utf8_decode($senha)."','".utf8_decode($perfil)."')");
if($execAtualiza){
	?>
