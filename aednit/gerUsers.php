				...
				<div id="content">
				  ...
				  <div class="project-column">
				    ...
				    <div class="project-shadow">
				      <div class="project-thumbnail"> <img src="img/gerusers.png"  alt="Feature image" /></div>
				      <!-- meta -->
				      <!-- ENDS meta -->
			        </div>
				    <!-- ENDS shadow -->
				  ...
				  <div class="project-column">
				    <div>
				      <table border="1">
				        <tr>
				          <td colspan='2' align="center"><a href="aprovarUser.php"><img src="img/gerirUsers.png"></a></td>
			            </tr>
				        <TR>
				          <td><a href="relatoriosUser.php"><img src="img/relatoriosUser.png"></a></td>
                          <td><a href="enviaMensagem.php"><img src="img/msgUser.png"></a></td>
				          </tr>
				         </table>
			        </div>
				    <p>&nbsp;</p>
