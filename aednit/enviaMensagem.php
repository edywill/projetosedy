...
if(empty($_SESSION['usuarioID']) || ($_SESSION['usuarioPerfil']<>'A')){
	?>
			...
			<div id="main">
				...
				<div id="content">
				  <!-- title -->
				  <div id="page-title"> <span class="title">Administração</span> <span class="subtitle">Envio de Mensagem para Usuarios!</span> </div>
				  <!-- ENDS title -->
				  <!--project column (right) -->
				  
                  <h1 class="project-title">Envia Mensagem</h1>
				    <div>
                    <form name="salvarImg" method="post" enctype="multipart/form-data" action="encaminhaEmailGrupo.php">
				      <table border="1">
				        <tr>
				          <td>Assunto:</td>
