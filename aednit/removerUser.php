	...
	?>
			...
			<div id="main">
				...
				<div id="content">
				  ...
				  <div class="project-column">
				    <div>
                    Digite parte do nome do usuário que deseja remover e clique em buscar:
				      <form action="removListaUsers.php" method="get" name="formulario">
                      <table border="1">
                      <tr><td><input name="busca" size="30" type="text"></td><td><input type="submit" value="OK"></td></tr>
			          </table>
                      </form>
			        </div>
				    <p>&nbsp;</p>
