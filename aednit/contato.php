...
<?php include "header.php"; ?>
			...
			<div id="content">
				...
				<div id="page-title">
					...
					<span class="subtitle">Utilize o formulário abaixo ou entre contato nos telefones informados.</span>
				</div>
				<!-- ENDS title -->
				...
				<div class="one-column">
					...
					<form id="contactForm" action="enviaEmail.php" method="post">
						<fieldset>
							<div>
								<label>Nome</label>
								<input name="name"  id="name" type="text" class="form-poshytip" title="Entre com seu nome completo" />
							</div>
							<div>
								<label>Email</label>
							...
							<div>
								<label>Lotação</label>
								<input name="uf"  id="uf" type="text" class="form-poshytip" title="Entre com a sua lotação." />
							</div>
							<div>
				...
				<div class="one-column">
					...
					(61) 3315-4229<br/>
					<a href="mailto:aednit@aednit.org,br">contato@aednit.org,br</a></p>
					<!-- ENDS content -->
				</div>
				<!-- ENDS column -->							
