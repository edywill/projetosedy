...
<body>
<div id="box3">
<strong>CI Web - Justificativa:</strong>
<?php 
//include "function.php";
echo "<div id='funcoes' style='display: none;'>";
$solicitacao=$_POST['id_ci'];
$setorGestor=$_POST['setorGestor'];
$idUsuario=$_POST['user_ci'];
include "functionPrazos.php";
$titulo='';
$comando='';
$obs='';
if($_POST['tipo']=='A'){
	$titulo="<strong>Justificar Aprova&ccedil;&atilde;o</strong>";
	$comando='A';
	$obs="Ser&aacute; encaminhado para o presidente.";
	}else{
	$titulo="Justificar Recusa";
	$comando='R';
	$obs='';
		}
echo "</div>";
echo $titulo;
echo "<br>CI N&ordm;: ".$solicitacao;
?>
<form action='ciWFPrazoGestAt.php' method='post' name='form4.id_CI' >
<input name="solicitacao" type="hidden" value="<?php echo $solicitacao; ?>" /><input name="comando" type="hidden" value="<?php echo $comando; ?>" /><input name="usuario" type="hidden" value="<?php echo $idUsuario; ?>" /><input name="setorGestor" type="hidden" value="<?php echo $setorGestor; ?>" />
<strong>Justificativa da CI: </strong>
  <textarea name="justificativa" id="justificativa" cols="100" rows="10" onKeyUp="limitaTextarea(this.value)"></textarea><br />
  <strong>Campo (caracteres restantes:</strong> <span id="contador">5000</span>)
<br />
<input name="cont" type="submit" class="button" value="Continuar &gt;&gt;" />
<?php 
echo $obs;
?>
</form>
