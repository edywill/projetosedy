...
<body>
<div id="box3">
<h2>Orçamento - Opções</h2>
<?php 
include "funcOrc.php";
if(!empty($_GET['usuario'])){
	$usuario=$_GET['usuario'];
	$_SESSION['userOrc']=$usuario;
	}else{
	$usuario=$_SESSION['userOrc'];	
		}
$usuarioOrc=buscaTipoUser($usuario);
echo "<table border='0'  width='500px'>
	<tr>";
	
echo "<td height='100'>
		<center><a href='orcLimites.php'><img width ='30%' src='css/edit.png'></img><br/><strong>Limites Orçamento<br/><br/></strong></a></center>
	</td>";
if($usuarioOrc==1){
echo "<td height='100'>
		<center><a href='orcCadLimite.php'><img width ='30%' src='css/new.png'></img><br/><strong>Cadastrar Limites<br/><br/></strong></a></center>
	</td>
	<td height='100'>
		<center><a href='orcLancamentos.php'><img width ='30%' src='css/search.png'></img><br/><strong>Lançar Valores<br><br/></strong></a></center> 
	</td>";
}
	echo "</tr>";
 ?>
