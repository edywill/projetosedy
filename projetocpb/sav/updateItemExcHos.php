<?php 
			 ...
			 $deletarHospedagemsExclusivas=odbc_exec($conCab2,"DELETE FROM TEITEMSOLHOTEL WHERE cd_solicitacao='".$solicitacao."'");	 
...
$dtVoltaHospSav=converteData($objRegistrosHos->dtvolta);
					...
					$sqlConsidHos="select MAX(id_registro) as id from TEITEMSOLHOTEL (nolock)";
