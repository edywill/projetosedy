...
$valida=0;
if($futuro>1){
$sqlId=mysql_fetch_array(mysql_query("SELECT max(id) AS maxid FROM savdirex WHERE tipo=1"));
...
if(!$sqlId){
	...
	$insertValorVr=mysql_query("INSERT INTO savdirex VALUES('','".$vigencia."','".utf8_decode($valor)."','1')");
	if(!$insertValorVr){
		$valida=1;
		}
	}
