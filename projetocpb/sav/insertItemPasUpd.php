...
$consultaPzentPas="Select
			...
			$resultPzentPas = odbc_fetch_array(odbc_exec($conCab2, $consultaPzentPas));
			$prazoEntregaPas=$resultPzentPas['Pzent'];
			$sqlNcmPas="Select
		  			 ESCLASFI.Ncm
					From
...
$peIPIPas=0;
	...
	$sqlSequenciaDiaPassagem="Select
	...
	$resSequenciaDiaPassagem = odbc_exec($conCab2, $sqlSequenciaDiaPassagem);
	$arraySequenciaDiaPassagem = odbc_fetch_array($resSequenciaDiaPassagem);
	$seqDiaPas=(int)$arraySequenciaDiaPassagem['SeqDia']+2;
