...
$consultaPzentHos="Select
			...
			$resultPzentHos = odbc_fetch_array(odbc_exec($conCab2, $consultaPzentHos));
			$prazoEntregaHos=$resultPzentHos['Pzent'];
			$sqlNcmHos="Select
		  			 ESCLASFI.Ncm
					From
...
$peIPIHos=0;
	...
	$sqlSequenciaHosPassagem="Select
