...
$scriptDatasAnteriores=mysql_query("SELECT savpassagem.idsav FROM savpassagem INNER JOIN savregistros ON savpassagem.idsav=savregistros.id WHERE savpassagem.dtida='".$_SESSION['dtidaSav2']."' AND savpassagem.origem='".$arrayOrigemIda[0]."' AND savregistros.funcionario='".$_SESSION['idFuncSav']."'") or die(mysql_error());
