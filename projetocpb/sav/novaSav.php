...
<strong>EVENTO:</strong></td><td width="79%"><input type="text" class="input" name="evento" id="evento" size="40" maxlength="40" value='<?php echo $_SESSION['eventoSav']; ?>' onBlur="this.value=this.value.toUpperCase()"/></td></tr><tr height="34"><td>
