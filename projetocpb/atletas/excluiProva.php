...
$sqlDeletaProva=odbc_exec($conCab,"DELETE FROM prova WHERE id='".$_GET['id']."'") or die(mysql_error());
...
if($sqlDeletaProva){
	...
	$sqlLogAtleta=odbc_exec($conCab,"INSERT INTO log(id,atleta,usuario,dthora,acao) VALUES (".$novoIdLog.",0,'".$userCriac."','".date("d/m/Y H:i:s")."','Exclui Prova ".utf8_decode($_GET['descr'])."')");
