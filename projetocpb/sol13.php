...
$usuarioSolF=$_GET['usuario'];
 ?>
<br />
Caso deseje solicitar o adiantamento da 1º parcela do seu 13º salário, selecione o seu gestor direto e clique no botão enviar:
<br /><br />
<form action="incluiSolicitacao13.php" method="post" name="form3" onsubmit="return validaCampo();" >
<table width="484" border="0">
 ...
 <tr><td></td>
    <td width="84"><input class="button" name="enviar" type="submit" value="enviar" /></td>
</tr>
</table>
<br />
<br />
...
<?php
montaGradePendente13($usuarioSolF);
?>
<br />
<strong>Solicitações Aprovadas:</strong>
<?php
montaGradeAprovadas13($usuarioSolF);
?>
<br />
<strong>Solicitações Recusadas:</strong>
<?php
montaGradeRecusadas13($usuarioSolF);
?>
</div>
</body>
</html>
