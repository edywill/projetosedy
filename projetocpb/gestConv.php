...
var url = "consConv.php?valor="+valor;
...
<a href="cadConv.php"><input type="button" class="button" value="Cadastrar Novo Evento" /> </a><a href="cadConvPerm.php"><input type="button" class="button" value="Cadastrar Recursos Humanos Permanentes" /> </a><a href="#"><input type="button" class="button" value="Relatórios" /> </a><br />
<br /><br />
<strong>Gerenciar Eventos:</strong><br /><br />
