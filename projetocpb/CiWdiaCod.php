...
function retorna(retorno)
        {
           window.opener.document.getElementById('diaCod').value = retorno;
		   window.opener.document.getElementById('diaCod').focus();
           window.self.close();
        }
</script>
<body>
Di&aacute;rias / Aux&iacute;lio Viagem - Benefici&aacute;rio
<br />
