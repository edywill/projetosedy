...
$sqlDadosRh=mysql_query("SELECT convrh.*,convrhreferencia.funcao FROM convrh,convrhreferencia WHERE convrh.id='".$idItem."' AND convrh.nome=convrhreferencia.id") or die(mysql_error());
$arrayDadosRh=mysql_fetch_array($sqlDadosRh);
$nome=$arrayDadosRh['nome']."-".utf8_encode($arrayDadosRh['funcao']);
