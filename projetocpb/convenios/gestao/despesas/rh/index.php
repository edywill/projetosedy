...
$sqlRhPerm=mysql_query("SELECT convrh.*,convrhreferencia.funcao FROM convrh,convrhreferencia WHERE convrh.idproj='".trim($id)."' AND convrh.modal='".$tipoId."' AND convrh.idcargo=convrhreferencia.id AND convrh.idevento='".$idEvento."'") or die(mysql_error());
