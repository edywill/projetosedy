...
echo "<h3>Cadastro de Solicitação de Transporte</h3>";
...
if($tipoLocEvento=='Nacional'){
	$cidadeHos=utf8_encode($arrayDetEvento['cidade']);
}else{
	$cidadeHos=utf8_encode($arrayDetEvento['cidade'])."/".$arrayDetEvento['pais'];
	}
$titButton='Cadastrar';
echo "<form action='insereNovoTra.php' name='formProjConv' method='post'>";
