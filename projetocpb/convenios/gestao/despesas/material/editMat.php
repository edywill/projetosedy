...
$consultaDadosMat=mysql_fetch_array(mysql_query("SELECT * FROM convmat WHERE id='".$idItem."'"));
$descricao=$consultaDadosMat['descricao'];
$qtd=$consultaDadosMat['qtd'];
$vlunitreal=$consultaDadosMat['vlunitreal'];
$totalreal=$consultaDadosMat['totalreal'];
$txcamb=$consultaDadosMat['txcamb'];
$vlunitmoeda=$consultaDadosMat['vlunitmoeda'];
$totalmoeda=$consultaDadosMat['totalmoeda'];
$dtcotacao=$consultaDadosMat['dtcotacao'];
$tipo=$consultaDadosMat['tipo'];
$moeda=$consultaDadosMat['moeda'];
$titButton='Atualizar';
echo "<form action='updateMat.php' name='formProjConv' method='post'>";
echo "<input type='hidden' name='idproj' value='".$idProj."'/>
<input type='hidden' name='idMat' value='".$_POST['idMat']."'/>
