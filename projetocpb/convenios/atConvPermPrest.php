...
$sqlPerm=mysql_query("SELECT prhpermanente.*,modalidade.id AS idMod,modalidade.modalidade FROM prhpermanente,modalidade WHERE prhpermanente.id=".$_POST['idEvento']." AND prhpermanente.idmodalidade=modalidade.id") or die(mysql_error());
...
<body>
<div id='box3'><br/>
<strong>PRESTAR CONTAS DE RECURSOS HUMANOS PERMANENTES:</strong><br /><br />
<div id="tabela">
<form action="atEventoConvPermPrest.php" method="post" onsubmit="this.elements['ok'].disabled=true;">
<table border="1" width="400">
<tr><th width="18%">Modalidade</th><td width="82%"><input type="hidden" name="validador" value="2" /><input type="hidden" name="id" value="<?php echo $arrayPerm['id']; ?>" /><?php echo $arrayPerm['modalidade']; ?>
</td></tr>
<tr>
  <th>Especificação (Função):</th><td><?php echo $arrayPerm['funcao']; ?></td></tr>
<tr>
...
<tr>
  ...
  <tr>
  <th>Justificativa para Alteração:</th><td><input name="just" id="just" type="text" size="60" class="input" value="<?php echo $arrayPerm['just']; ?>"/></td></tr>
<tr><td><a href="prestConv.php"><input type="button" value="Voltar" name="voltar" /></a></td><td><input id="ok" type="submit" class="button" value="Cadastrar" name="ok" /></td></tr>
</table>
</form>
</div>
</div>
