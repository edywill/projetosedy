...
<!-- insira o seguinte c�digo de javascript em sua p�gina. -->
...
<!-- 
o css abaixo � apenas para dar uma apar�ncia melhor para o calend�rio. vc pode mud�-lo a sua maneira 
insira o c�digo abaixo entre as tags <HEAD> </HEAD> de sua p�gina
-->
<style>
...
{
alert("O Campo titulo � obrigat�rio!");
return false;
}
else
return true;
...
consultaRHferias($dataInicio);

echo "<a href='rhFerias.php'><strong>Voltar</strong></a>"
